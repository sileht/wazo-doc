...
Alice retrieves a token using her
    username/password:
...
authentication source is determined by the <span data-role="ref">backend
\<auth-backends\></span> in the POST data.
...
If Alice wants to revoke her token before its
    expiration:
...
See <span data-role="ref">service-authentication</span> for details
...
See also the <span data-role="ref">wazo-auth changelog
\<rest-api\_changelog\></span>.

## Development

See <span data-role="ref">wazo-auth-developer</span>.
